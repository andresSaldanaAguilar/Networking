        ...
        while self.stopped():
            ...
            if self.label2 == "On use":
                ...
                ret = rrdtool.graphv( self.filename+".png",
                    ...
                    #establecer el umbral1
                    "CDEF:umbral25=carga,"+str(self.umbral1)+",LT,0,carga,IF",
                    "AREA:carga#2581F3:Carga del CPU",
                    "AREA:umbral25#2581F3:Tráfico de carga mayor que "+str(self.umbral1)+"",
                    "HRULE:"+str(self.umbral1)+"#2581F3:Umbral 1 - "+str(self.umbral1)+"%",

                    #establecer el umbral 2
                    "CDEF:umbral30=carga,"+str(self.umbral2)+",LT,0,carga,IF",
                    "AREA:umbral30#EA31BE:Tráfico de carga mayor que "+str(self.umbral2)+"",
                    "HRULE:"+str(self.umbral2)+"#EA31BE:Umbral 2 - "+str(self.umbral2)+"%",

                    #establecer el umbral 3
                    "CDEF:umbral35=carga,"+str(self.umbral3)+",LT,0,carga,IF",
                    "AREA:umbral35#F82205:Tráfico de carga mayor que "+str(self.umbral3)+"",
                    "HRULE:"+str(self.umbral3)+"#F82205:Umbral 3 - "+str(self.umbral3)+"%",
