...
class AgentManager():
    ...
    def agentMonitoring(
        ...
        for k,v in self.data.items():
            ...
            #estadisticas ICMP
            createRDD("ICMP"+k,2)
            u3 = updateRDD("ICMP"+k,v['community'],v['hostname'],'1.3.6.1.2.1.5.1.0','1.3.6.1.2.1.5.14.0')
            ...
            #estadisticas SNMP
            createRDD("SNMP"+k,2)
            u3 = updateRDD("SNMP"+k,v['community'],v['hostname'],'1.3.6.1.2.1.5.1.0','1.3.6.1.2.1.5.14.0')
            ...
            #estadisticas TCP
            createRDD("TCP"+k,2)
            u3 = updateRDD("TCP"+k,v['community'],v['hostname'],'1.3.6.1.2.1.6.10.0','1.3.6.1.2.1.6.11.0')
